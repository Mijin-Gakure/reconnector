This script monitors Conan Exiles log files to detect when a player has disconnected, and then automatically attempts to reconnect every 6 minutes or so. This feature is beneficial for players who wish to continue collecting points in the game while afk and for admins aiming to maintain server activity above the threshold that attracts new players.
